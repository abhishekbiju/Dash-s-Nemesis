...
#                                                                       #========================#      
        ...
        if power_move and not dioHurt and not dio_pause_real and render:
                ...
                powermovelist=["1","1","1","1","1","1","1","1","2","2","2","2","3","4","4"]                
                if dio_move=="1":
...
#
    ...
    while gameRun==True:
        ...
        if enemy_health<=0:
            ...
            scoreV=int((time_frame/10)*2.5)
            scoreV=int(time_frame/10)
            show_score(textX,textY)
            
        
        '''db=mysql.connector.connect(host='localhost', user='root', passwd='123', database = 'DASH')
        db.is_connected
        cur = db.cursor()
        cur.execute("create database if not exists DASH")

        cur.execute("use DASH")
        cur.execute("create table if not exists SCORE(BEST_TIMES int)")
        scoreV=int(time_frame/10)
        sql = "INSERT INTO score VALUES (%s)"
        val = (scoreV)
        cur.execute(sql, val)
        db.commit()

        #cur.execute("select BEST_TIMES,RANK() OVER (ORDER BY BEST_TIMES desc) as RANK from SCORES ORDER BY RANK desc")
        #cur.execute("select * from SCORE ORDER BY BEST_TIMES desc")
...
#                                                                       #====================================#
#-----------------------------------------------------------------------# LEADERBOARD THROUGH FILE HANDLING  #-----------------------------------------------------------------------------------------------------------------------------
#                                                                       #====================================#
...
#
        ...
        with open('leaderboard.csv','a') as f:
            csvr=csv.reader(f)
            sort = sorted(csvr,key=int,reverse=True)
            for i in sort:
                print(i)'''
#
...
while z==True:
    ...
    if(event.type==pygame.KEYDOWN):
        if (event.type==pygame.QUIT or event.key==pygame.K_ESCAPE ):
            ...
            quit()
with open('leaderboard.txt','a') as f:
    individual_value = str(scoreV) + '\n'
    f.write(individual_value)

print('Your score is:', scoreV)
print('Check out how you rank among our top scores of all time!')
print('='*60)
print('%10s'%('Rank'),'%20s'%('Score'))
print('='*60)
with open('leaderboard.txt','r+') as f:
    order=[]
    rec = f.readlines()
